...
| **qrcode** | 8.0 | QR-код для Authenticator |
...
| **pdfjs-dist** | 4.9.155 | PDF-рендеринг (низкий уровень) |
| **react-pdf** | 9.1.1 | PDF-читалка в браузере (компонентная) |
...
| **Tailwind CSS** | 3.4.17 | CSS-утилитарный фреймворк |
...
| Протокол | Применение |
|---------|-----------|
| **OPDS 1.2** | Каталог для e-reader (Atom-фид) |
...
| **qrcode** | 8.0 | QR code for Authenticator setup |
...
| **pdfjs-dist** | 4.9.155 | PDF rendering (low-level) |
| **react-pdf** | 9.1.1 | In-browser PDF reader (component-based) |
...
| Protocol | Usage |
|---------|-------|
| **OPDS 1.2** | E-reader catalog (Atom feed) |
